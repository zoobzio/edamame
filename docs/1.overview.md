...
Edamame provides named capabilities over soy's query builder. Each capability maps a declarative spec to a parameterized SQL builder. The factory maintains capability registries with thread-safe access.
